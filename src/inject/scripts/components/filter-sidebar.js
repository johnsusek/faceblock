  ...
  methods: {
    toggleTrending() {
      if (this.hideTrending) {
        document.body.classList.add('faceblock_hide_trending');
      } else {
        document.body.classList.remove('faceblock_hide_trending');
      }
    },
    toggleSponsored() {
      if (this.hideSponsored) {
        document.body.classList.add('faceblock_hide_sponsored');
      } else {
        document.body.classList.remove('faceblock_hide_sponsored');
      }
    }
  }
});
